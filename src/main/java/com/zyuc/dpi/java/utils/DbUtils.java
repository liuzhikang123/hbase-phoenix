...
public  class DbUtils {
    ...
    private static Connection getDBConnection(Config config) {
        ...
        String dbDriver = config.getString("mysqljdbc.driver");
        String dbUrl = config.getString("mysqljdbc.url");
        String dbUser = config.getString("mysqljdbc.user");
        String dbPass = config.getString("mysqljdbc.password");
