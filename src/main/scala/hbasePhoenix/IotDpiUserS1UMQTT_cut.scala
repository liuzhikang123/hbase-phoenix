...
//      "SessionStopFlag",
  ...
  def parse(line: String) = {
    try {
      ...
      val Version = fields(64)
      val ProcedureType = fields(65)
      val ClientID = fields(66)
      val UserName = fields(67)
      val MQTT = fields(68)
      val KeepAlive = fields(69)
      val DupFlag = fields(70)
      val Qos = fields(71)
      val Protocol_Name = fields(72)
      val Topic_Name = fields(73)
      val Topic2_Name = fields(74)
      val Topic3_Name = fields(75)
      val Message_Action = fields(75)
      val MsgActionAck = fields(76)
      val MessageID = fields(77)
      val RepeatCount = fields(78)
      val MsgActionTime = fields(79)
      val MsgActionAck_Time = fields(80)
      val Pubreceived_Time = fields(81)
      val Pubrelease_Time = fields(82)
      val PubComplete_Time = fields(83)
      val Status = fields(84)
      val Result = fields(85)
      ...
      Row(Interface,IMSI,MSISDN,IMEI,APN,
        ...
        TCPSynNumber,TCPConnetState,SessionStopFlag,Roma_Province,//new add
